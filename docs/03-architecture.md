...
工作代理、模型 provider 和 MemoryEngine 分开适配。产品持有 WorkCase、Experience、Playbook 元数据和用户控制；Hindsight 持有原文、事实、图、内部归纳及当前 Playbook 正文。原生 ID、bank 和 score 不成为公开产品身份或可信度。
