...
manifest={"compatibility":{"productSchema":1,"protocol":1,"activationCheck":1,**{key:components[key] for key in ["hindsight","postgresql","pgvector"]}},"version":"0.0.1-dev","platform":"win32-x64","releaseReady":False,"files":sorted(files,key=lambda f:f["path"])}
